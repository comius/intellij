...
public class UnpackedAarsTest extends BlazeTestCase {
  ...
  private ArtifactLocation gen(String relativePath) {
  ...
  public void testRefresh_fileNotExist_success() throws IOException {
    ...
    ArtifactLocation resourceAarArtifactLocation = gen(resourceAar);
  ...
  public void testRefresh_success() throws IOException {
    ...
    ArtifactLocation importedAarArtifactLocation = gen(importedAar);
    ArtifactLocation jarArtifactLocation = gen(importedAarJar);
    ...
    assertThat(getContent(new File(resourceAarDir, stringsXmlRelativePath)))
        .isEqualTo(STRINGS_XML_CONTENT);
    assertThat(getContent(new File(importedAarDir, colorsXmlRelativePath)))
